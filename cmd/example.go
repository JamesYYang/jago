...
func main() {
	...
	// loadJagoRoutes(jago, static)
	// loadJagoRoutes(jago, gplusAPI)
	// loadJagoRoutes(jago, githubAPI)
	// loadJagoRoutes(jago, parseAPI)
	loadJagoRoutes(jago, complexAPI)
	server := &http.Server{
		Handler: jago,
		Addr:    ":8080",
	}
